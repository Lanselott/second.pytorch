...
_VOXELNET_RPN = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='corr_patch_size', full_name='second.protos.VoxelNet.RPN.corr_patch_size', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='corr_kernel_size', full_name='second.protos.VoxelNet.RPN.corr_kernel_size', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='corr_dilation_patch', full_name='second.protos.VoxelNet.RPN.corr_dilation_patch', index=11,
...
_VOXELNET.fields_by_name['voxel_generator'].message_type = voxel__generator__pb2._VOXELGENERATOR
...
_VOXELNET.fields_by_name['loss'].message_type = losses__pb2._LOSS
_VOXELNET.fields_by_name['loss_norm_type'].enum_type = _VOXELNET_LOSSNORMTYPE
_VOXELNET.fields_by_name['box_coder'].message_type = box__coder__pb2._BOXCODER
_VOXELNET.fields_by_name['target_assigner'].message_type = target__pb2._TARGETASSIGNER
