...
if __name__ == "__main__":
    ...
    # imageio.imwrite("warped_map.png", warped_map.cpu().numpy().reshape(10, 10))
    # imageio.imwrite("previous_map.png", previous_map.cpu().numpy().reshape(10, 10))
